#### 介绍
<h1><b>spring boot > 2.0.0 + 版本、 jdk 1.8 + </b></h1>
...
#### 更新说明
<p>1、  2.0.8 开启spring boot 2.0 + 版本、jdk 1.8 支持</p>
...
| 依赖                                      | 版本    | 描述                 |
|-----------------------------------------|-------|--------------------|
| spring-boot-invoker-annotations         | 2.1.0 | invoker注解包         |
| spring-boot-invoker-core                | 2.1.0 | invoker核心包         |
| spring-boot-invoker-hystrix             | 2.1.0 | invoker熔断          |
| spring-boot-starter-invoker             | 2.1.0 | spring boot使用      |
| spring-boot-starter-redis-invoker       | 2.1.0 | spring redis使用     |
| spring-boot-starter-amqp-invoker        | 2.1.0 | spring rabbitmq使用  |
| spring-boot-starter-websocket-invoker   | 2.1.0 | spring websocket使用 |
| spring-cloud-starter-invoker            | 2.1.0 | spring微服务使用        |
| spring-invoker-dependencies             | 2.1.0 | 版本依赖               |
