...
class RemoteClientBeanDefinitionRegistryPostProcessor extends RemoteClientImportBeanDefinitionRegistrar<RemoteClient> implements BeanDefinitionRegistryPostProcessor {
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) throws BeansException {
        for (String beanDefinitionName : registry.getBeanDefinitionNames()) {
            Class<?> beanClass = BeanDefinitionRegistryUtils.getBeanDefinitionToClass(( ConfigurableListableBeanFactory ) registry, beanDefinitionName);
            try {
                AnnotationMetadata annotationMetadata = getAnnotationMetadata(beanClass.getName());
