 ...
 **/
@Component
public class RedisSpringInvokerSampleServiceHystrix implements FallbackFactory<RedisSpringInvokerSampleServiceFacade> {

    @Override
    public RedisSpringInvokerSampleServiceFacade create(Throwable var1) {
        var1.printStackTrace();
        return new RedisSpringInvokerSampleServiceFacade(){
