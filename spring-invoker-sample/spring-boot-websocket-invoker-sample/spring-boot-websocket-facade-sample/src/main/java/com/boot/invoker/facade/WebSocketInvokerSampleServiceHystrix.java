 ...
 **/
@Component
public class WebSocketInvokerSampleServiceHystrix implements FallbackFactory<WebSocketInvokerSampleServiceFacade> {

    @Override
    public WebSocketInvokerSampleServiceFacade create(Throwable var1) {
        var1.printStackTrace();
        return new WebSocketInvokerSampleServiceFacade(){
