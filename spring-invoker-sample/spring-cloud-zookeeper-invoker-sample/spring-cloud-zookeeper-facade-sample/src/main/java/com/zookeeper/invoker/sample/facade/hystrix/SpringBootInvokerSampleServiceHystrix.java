...
import com.zookeeper.invoker.sample.facade.ZookeeperInvokerSampleServiceFacade;
...
//    }
    ...
    public Object create(Throwable var1) {
        ZookeeperInvokerSampleServiceFacade serviceFacade = (ZookeeperInvokerSampleServiceFacade) () -> null;
