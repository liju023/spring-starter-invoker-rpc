 ...
 */
public class RedisCloseException extends RuntimeException{
    ...
    public RedisCloseException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
