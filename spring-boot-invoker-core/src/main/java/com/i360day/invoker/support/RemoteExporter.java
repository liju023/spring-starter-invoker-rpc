...
public abstract class RemoteExporter extends RemotingSupport {
	...
	private RemoteInvocationTraceInterceptor remoteInvocationTraceInterceptor = new DefaultRemoteInvocationTraceInterceptor();


	public RemoteInvocationTraceInterceptor getRemoteInvocationTraceInterceptor() {
		return remoteInvocationTraceInterceptor;
	}

	public void setRemoteInvocationTraceInterceptor(RemoteInvocationTraceInterceptor remoteInvocationTraceInterceptor) {
		this.remoteInvocationTraceInterceptor = remoteInvocationTraceInterceptor;
	}
	 ...
	 * @see DefaultRemoteInvocationTraceInterceptor
	 */
	 ...
	 * {@link DefaultRemoteInvocationTraceInterceptor} will be registered (by default).
	 * @return the proxy
	 * @see #setServiceInterface
	...
	protected Object getProxyForService() {
		...
		if (this.registerTraceInterceptor != null ? this.registerTraceInterceptor : this.interceptors == null) {
			RemoteInvocationTraceInterceptor defaultRemoteInvocationTraceInterceptor = Optional.ofNullable(getRemoteInvocationTraceInterceptor()).orElse(new DefaultRemoteInvocationTraceInterceptor());
			proxyFactory.addAdvice(defaultRemoteInvocationTraceInterceptor);
		}
