 ...
 */
public class DefaultRemoteInvocationTraceInterceptor implements RemoteInvocationTraceInterceptor {

	protected static final Log logger = LogFactory.getLog(DefaultRemoteInvocationTraceInterceptor.class);
	 ...
	 */
	public DefaultRemoteInvocationTraceInterceptor() {
		this.exporterNameClause = ClassUtils.getShortName(getClass());
	}
	 ...
	 */
	public DefaultRemoteInvocationTraceInterceptor(String exporterName) {
