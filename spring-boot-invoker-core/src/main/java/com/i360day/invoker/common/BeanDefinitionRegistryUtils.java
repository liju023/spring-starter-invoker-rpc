...
public class BeanDefinitionRegistryUtils {
    ...
    public static Class<?> getBeanClass(BeanDefinitionRegistry definitionRegistry, Class<?> clazz) {
        try{
            ...
            return getBeanDefinitionToClass((ConfigurableListableBeanFactory) definitionRegistry, beanName);
        }catch (Exception ex){
     ...
     * @return
     */
    public static Class<?> getBeanDefinitionToClass(ConfigurableListableBeanFactory definitionRegistry, String beanDefinitionName) {
        BeanDefinition mergedBeanDefinition = definitionRegistry.getMergedBeanDefinition(beanDefinitionName);
        return ClassUtils.getUserClass(mergedBeanDefinition.getResolvableType().toClass());
    }
}
